...
kt = LINETCR.LINE()
kt.login(token="EoYHDEHROo5XkqT1D6E4.0Rb8xRP01SQT8JW2BG0qra.NRk8F4aH0VVyVliePYGLvX290/gMvUYE303E23/5bmY=")
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token="Eot5HIihzRCzhDPOqtr4.x9i+ZcKnrCTncdU/cQj4na.+yEQbujRuKP/eaG/eg++H4ASA0rcCX5H1GibbkFpSgU=")
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token="EooGL4CPhrmU9jPjuz73.8T1HtMmxpZnBlzFzh5m4aW.k8PHEjYLK+Egln+Yw2lGnOjcsujoDiOHhAIU25pz/DA=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="Eoim0B6iRSC3zQaK33we.Z8u7JHOagIMP4RurQt9jhG.bv3wGDo+Afh12BWjGZuWR7sZWxUK6D9Vr8tmmlGTN9k=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Eon6l6bO251RupMZ7Hk8.1COZ+eyUW15GmPtAm/cuka.twJWS6kTzudSIOTTQCUDiMCeWOSuGhTFC9MfiZrIG/4=")
kc.loginResult()

kl = LINETCR.LINE()
kl.login(token="EoKxJFpA6GmBaRDvFduf.28lJ/KNMaYjd9dM+81Tf7W.5FpKi/KiQ0fuyR26vRVrQfg4jJRMuD81qBosAkZ9A0M=")
kl.loginResult()
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"ubafe934229c328e2c606793900071c78"]
admin = ["ubafe934229c328e2c606793900071c78"]
owner = ["ubafe934229c328e2c606793900071c78"]
creator=["ubafe934229c328e2c606793900071c78"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#===========================================
        if op.type == 32:
            if not op.param2 in Bots and admin:
              if not op.param2 in owner and creator:
        ...
        if op.type == 17:
            if op.param3 in wait["blacklist"]:
                if not op.param2 in Bots + admin + owner + creator: 
              ...
              if not op.param2 in owner and creator:
                if wait["protectionOn"] == True:  
                    ...
                    if G is not None:
                        ...
                        cl.sendMessage(c)
        if op.type == 15:
             if op.param2 in admin + owner + creator:
                random.choice(KAC).inviteIntoGroup(op.param1,[op.param2])
        if op.type == 19:
             if op.param2 in Bots:
                   if op.param3 in admin + owner + creator:
        ...
        if op.type == 19:
                ...
                if not op.param2 in Bots + admin + owner + creator:
                  if wait["Backup"] == True:
                    try:
                        random.choice(KAC).inviteIntoGroup(op.param1, [op.param3])
                        random.choice(DET).inviteIntoGroup(op.param1, [op.param3])
                    except Exception, e:
                        print e
        if op.type == 19:              
                if mid in op.param3:
...
#========================================================================
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                kl.like(url[25:58], url[66:], likeType=1001)
        if op.type == 26:
            msg = op.message
            if msg.contentType == 13:
              ...
              if msg.from_ in admin + owner + creator:
                if wait["lang"] == "JP":
                    cl.sendText(msg.to, helpinvite + datetime.today().strftime('%H:%M:%S'))
                else:
                    cl.sendText(msg.to,helpinvite)
            elif msg.text.lower() == 'help1':
              if msg.from_ in admin + owner + creator:
                if wait["lang"] == "JP":
                    cl.sendText(msg.to, helppro + datetime.today().strftime('%H:%M:%S'))
                else:
                    cl.sendText(msg.to,helppro)
            elif msg.text.lower() == 'help2':
              if msg.from_ in admin + owner + creator:
                if wait["lang"] == "JP":
                    cl.sendText(msg.to, helpkick + datetime.today().strftime('%H:%M:%S'))
                else:
              ...
              if msg.from_ in owner + creator:
                if wait["lang"] == "JP":
                    cl.sendText(msg.to, helpsetting + datetime.today().strftime('%H:%M:%S'))
                else:
                    cl.sendText(msg.to,helpsetting)
            elif msg.text.lower() == 'help5':
              if msg.from_ in owner + creator:
                if wait["lang"] == "JP":
                    cl.sendText(msg.to, helpbc + datetime.today().strftime('%H:%M:%S'))
                else:
                    cl.sendText(msg.to,helpbc)
...
#==================================================
              ...
              if msg.from_ in creator:
                ...
                if len(string.decode('utf-8')) <= 200:
                    ...
                    profile.displayName = string
                    kl.updateProfile(profile)
                    kl.sendText(msg.to,"change name: "+string+"\nsucces")
#==================================================
...
#Tolong Jangan Ganti mid CreatorNya Hargai Saya yang membuat!!!#
              ...
              if msg.from_ in admin:
                ...
                if msg.from_ in creator:
                    print "[Command]Staff add executing"
                    _name = msg.text.replace("Owner on @","")
                    _nametarget = _name.rstrip(' ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                owner.append(target)
                                cl.sendText(msg.to,"succes add to ownerlist")
                            except:
                                pass
                    print "[Command]Staff add executed]"

            elif "Owner off @" in msg.text:
                if msg.from_ in creator:
                    print "[Command]Staff remove executing"
                    _name = msg.text.replace("Owner off @","")
                    _nametarget = _name.rstrip(' ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                owner.remove(target)
                                cl.sendText(msg.to,"Succes remove owner from adminlist")
                            except:
                                pass
                    print "[Command]Staff remove executed"
                else:
            ...
            elif "Anti on @" in msg.text:
                if msg.from_ in owner:
                    print "[Command]Staff add executing"
                    _name = msg.text.replace("Anti on @","")
                    _nametarget = _name.rstrip(' ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                Bots.append(target)
                                cl.sendText(msg.to,"succes add to AntiBot")
                            except:
                                pass
                    print "[Command]Staff add executed]"

            elif "Anti off @" in msg.text:
                if msg.from_ in creator:
                    print "[Command]Staff remove executing"
                    _name = msg.text.replace("Anti off @","")
                    _nametarget = _name.rstrip(' ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                Bots.remove(target)
                                cl.sendText(msg.to,"Succes remove Anti Bot")
                            except:
                                pass
                    print "[Command]Staff remove executed"
                else:
...
#==========================================================
               ...
               if msg.from_ in admin:
			kt.sendText(msg.to,mid)
			kt.sendText(msg.to,Amid)
			kt.sendText(msg.to,Bmid)
			kt.sendText(msg.to,Cmid)
			kt.sendText(msg.to,Dmid)
...
#=================================================================
              ...
              if msg.from_ in admin + owner + creator:
                if wait["protection"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Protection on Already\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        cl.sendText(msg.to,"Protection on Already\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
              ...
              if msg.from_ in admin + owner + creator:
                if wait["protection"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Protection off Already\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        cl.sendText(msg.to,"Protection off Already\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
...
#===========================================
              ...
              if msg.from_ in admin + owner + creator:
                ...
                kc.sendText(msg.to, "Bot Lengkap")
              ...
              if msg.from_ in admin:
	           ...
	           if msg.from_ in admin:
                ...
                try:
                    ...
                    cl.sendText(msg.to, "Restore  Sucses")
                except Exception as e:
                    cl.sendText(msg.to, str (e))
              ...
              if msg.from_ in admin:
                  if msg.toType == 2:
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                               if not target in Bots + admin + owner + creator:
                                   try:
                                       wait["blacklist"][target] = True
                                       f=codecs.open('st2__b.json','w','utf-8')
                                       json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
...
#--------------------------------------------------------
		...
		if msg.from_ in owner and creator:
		    ...
		    cl.sendText(msg.to, "Khusus Owner dan Creator")
            #--------------------------------------------------------
                ...
                if targets ==[]:
                        ...
                        for target in targets:
                                try:
                                        ...
                                        kl.sendText(msg.t,"Maaf Akun Sedang Limit!!")
                                        kl.leaveGroup(msg.to)
                                        gs = cl.getGroup(msg.to)
...
#========================================
              ...
              if msg.from_ in admin + owner + creator:
					...
					cl.updateGroup(G)
#========================================
            elif msg.text.lower() == 'kiker join':
              if msg.from_ in admin + owner + creator:
...
#=====================================================================================
              ...
              if msg.from_ in admin + owner + creator:
                ...
                try:
                     ...
                     pass
            elif msg.text.lower() == 'bye all':
              if msg.from_ in admin + owner + creator:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     cl.sendText(msg.to,"Kami Pergi Dulu!!")
                     ki.leaveGroup(msg.to)
                     kk.leaveGroup(msg.to)
                     kc.leaveGroup(msg.to)
                     ks.leaveGroup(msg.to)
                     kt.leaveGroup(msg.to)
                     kl.leaveGroup(msg.to)
                     cl.sendText(msg.to,"bye-bye semuanya")
                     cl.leaveGroup(msg.to)
                except:
                     pass
            elif msg.text.lower() == 'kiker out':
              if msg.from_ in admin + owner + creator:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = ""
			if op.param2 in Bots or admin or owner or creator:
				pass
			else:
				Inviter = op.param3.replace("",',')
				InviterX = Inviter.split(",")
